    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'les-101', title: '1.1 บทนำสู่ Angular 22 และการทำงานแบบ Zoneless', duration: '20 นาที', type: 'video', isCompleted: true, isPreviewable: true },
          { id: 'les-102', title: '1.2 Signals vs RxJS: การเลือกใช้งานที่เหมาะสมในระบบงานจริง', duration: '35 นาที', type: 'video', isCompleted: true, isPreviewable: true },
          { id: 'les-103', title: '1.3 สถาปัตยกรรม Reactive State ด้วย computed() และ effect()', duration: '25 นาที', type: 'video', isCompleted: true },
      ...
      },
      {
        ...
        lessons: [
          { id: 'les-201', title: '2.1 การนำเข้า Token และ CSS Variable ของ Soft Inter Chiangrai', duration: '25 นาที', type: 'video', isCompleted: true },
          { id: 'les-202', title: '2.2 การสร้าง Custom Control ด้วย SicFormControlBase', duration: '40 นาที', type: 'video', isCompleted: true },
          { id: 'les-203', title: '2.3 เอกสารประกอบ Guideline & Best Practices สำหรับ @sic-ng', duration: '15 นาที', type: 'pdf', isCompleted: false },
          { id: 'les-204', title: '2.4 Workshop: สร้าง Dynamic Filter Bar ด้วย Signals', duration: '45 นาที', type: 'video', isCompleted: false },
        ],
      },
      {
        id: 'mod-3',
        ...
        lessons: [
          { id: 'les-301', title: '3.1 วิเคราะห์ Bundle Size และการใช้ Deferrable Views (@defer)', duration: '30 นาที', type: 'video', isCompleted: false },
          { id: 'les-302', title: '3.2 การเขียน Unit Test สำหรับ Zoneless Signals Component', duration: '35 นาที', type: 'video', isCompleted: false },
          { id: 'les-303', title: '3.3 การจัดเตรียม CI/CD Pipeline สำหรับเผยแพร่ Library', duration: '20 นาที', type: 'article', isCompleted: false },
