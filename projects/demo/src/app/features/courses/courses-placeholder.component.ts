...
@Component({
  selector: 'app-courses-placeholder',
  standalone: true,
  ...
  template: `
    <div class="placeholder-page">
      <div class="placeholder-card">
        <div class="icon">🎓</div>
        <h2>คลังหลักสูตรทั้งหมด (Course Catalog)</h2>
        <p>กำลังเตรียมสร้างใน Step ถัดไป: ค้นหาคอร์ส, ตัวกรองหมวดหมู่ (Frontend, Backend, AI), และบัตรคอร์สพร้อมปุ่มลงทะเบียน</p>
...
export class CoursesPlaceholderComponent {}
